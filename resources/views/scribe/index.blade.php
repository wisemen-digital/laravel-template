                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-users--user_id-">GET api/users/{user_id}</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-users--user_id-">
                                <a href="#endpoints-POSTapi-users--user_id-">POST api/users/{user_id}</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be one of <code>admin</code> or <code>user</code>. Example: <code>user</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="franz.dickinson@example.net"
               data-component="body">
    <br>
<p>This field must be a valid email address. Example: <code>franz.dickinson@example.net</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="srt;TTp??i-I<hB=qd4"
               data-component="body">
    <br>
<p>Example: <code>srt;TTp??i-I&lt;hB=qd4</code></p>
        </div>
        </form>
...
<span id="execution-results-GETapi-users--user_id-" hidden>
    ...
    <pre class="json"><code id="execution-response-content-GETapi-users--user_id-" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-users--user_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-users--user_id-"></code></pre>
</span>
<form id="form-GETapi-users--user_id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-users--user_id-" hidden>Send Request 💥
            </button>
            </h3>
            <p>
            <small class="badge badge-green">GET</small>
...
<p>The ID of the user. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-users--user_id-">POST api/users/{user_id}</h2>
...
<span id="execution-results-POSTapi-users--user_id-" hidden>
    ...
    <pre class="json"><code id="execution-response-content-POSTapi-users--user_id-" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-users--user_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-users--user_id-"></code></pre>
</span>
<form id="form-POSTapi-users--user_id-" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-users--user_id-" hidden>Send Request 💥
            </button>
            </h3>
            <p>
            <small class="badge badge-black">POST</small>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
               name="Authorization" class="auth-value"               data-endpoint="POSTapi-users--user_id-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
               name="role"                data-endpoint="POSTapi-users--user_id-"
               value="admin"
               data-component="body">
    <br>
<p>Must be one of <code>admin</code> or <code>user</code>. Example: <code>admin</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>first_name</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
               name="first_name"                data-endpoint="POSTapi-users--user_id-"
               value="possimus"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
               name="last_name"                data-endpoint="POSTapi-users--user_id-"
               value="molestiae"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
               name="email"                data-endpoint="POSTapi-users--user_id-"
               value="tad57@example.net"
               data-component="body">
    <br>
<p>This field must be a valid email address. Example: <code>tad57@example.net</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
               name="password"                data-endpoint="POSTapi-users--user_id-"
               value="Jam2WFg;"
               data-component="body">
    <br>
<p>Example: <code>Jam2WFg;</code></p>
        </div>
        </form>
